...
# PASSING IN ODER Movie Name - String, Movie Description - String,
# FULL LINK TO MOVIE POSTER - String, FULL LINK TO TRAILER ON YOUTUBE - String

PulpFiction = media.Movie(
    'Pulp Fiction',
    '''Series of unfortunate events surrouding a suitcase and a bunch of
    low rent hitmen''',
...
SchoolOfRock = media.Movie(
    'The School Of Rock',
    '''A loser impersonates his friend as a substitute at a prep school to take
    part in a rock competition''',
...
Incredibles = media.Movie(
    'The Incredibles',
    '''A Super hero family go into witness protection, only to
...
FightClub = media.Movie(
    'Fight Club',
    '''An amnesiac and his friend start a violent club that
...
_movies = [
            PulpFiction,
            Goodfellas, SchoolOfRock,
            Incredibles, Godfather, FightClub
          ]
